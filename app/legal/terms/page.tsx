    ...
    return (
        <div className="min-h-screen bg-[#FAF9F6] dark:bg-[#1A1A1A] text-[#1A1A1A]/80 dark:text-slate-300 p-6 md:p-12 font-sans">
            <div className="max-w-4xl mx-auto">
                ...
                <h1 className="text-4xl font-bold text-[#1A1A1A] dark:text-white mb-8">Terms of Service</h1>
                ...
                <div className="space-y-6 bg-white/50 dark:bg-slate-800/50 p-8 rounded-2xl border border-[#1A1A1A]/5 dark:border-white/5 backdrop-blur-sm">
                    <section>
                        <h2 className="text-xl font-semibold text-[#1A1A1A] dark:text-white mb-2">1. Acceptance of Terms</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-semibold text-[#1A1A1A] dark:text-white mb-2">2. Description of Service</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-semibold text-[#1A1A1A] dark:text-white mb-2">3. User Conduct</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-semibold text-[#1A1A1A] dark:text-white mb-2">4. Event Liability</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-semibold text-[#1A1A1A] dark:text-white mb-2">5. Data & Privacy</h2>
